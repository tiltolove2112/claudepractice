                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolDoneLabel: Record<string, string> = {
                              str_replace_editor: "Code updated",
                              file_manager: "Files ready",
                            };
                            const isDone = tool.state === "result" && tool.result;
                            const label = isDone
                              ? (toolDoneLabel[tool.toolName] ?? "Done")
                              : (toolLabel[tool.toolName] ?? "Working...");
                            return (
